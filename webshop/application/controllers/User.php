...
class User extends MY_Controller {
	...
	{
		$this->data['temp']='site/user/thanhtoan.php';
		$this->load->view('site/layoutsub',$this->data);
	}
		public function quydinhmoshop()
	{
		$this->data['temp']='site/user/quydinhmoshop.php';
		$this->load->view('site/layoutsub',$this->data);
	}
			public function quydinhnguoiban()
	{
		$this->data['temp']='site/user/quydinhnguoiban.php';
		$this->load->view('site/layoutsub',$this->data);
	}
		public function cauhoithuonggap()
	{
		$this->data['temp']='site/user/cauhoithuonggap.php';
		$this->load->view('site/layoutsub',$this->data);
	}
	...
	{
		$this->data['temp']='site/user/contact.php';
		$this->load->view('site/layoutsub',$this->data);
	}
		public function baomat()
	{
		$this->data['temp']='site/user/baomat.php';
		$this->load->view('site/layoutsub',$this->data);
	}
		public function doitra()
	{
		$this->data['temp']='site/user/doitra.php';
		$this->load->view('site/layoutsub',$this->data);
	}
	public function chinhsach()
	{
		$this->data['temp']='site/user/chinhsach.php';
		$this->load->view('site/layoutsub',$this->data);
	}
		public function gioithieu()
	{
		$this->data['temp']='site/user/gioithieu.php';
		$this->load->view('site/layoutsub',$this->data);
	}
	public function giaohang()
	{
		$this->data['temp']='site/user/giaohang.php';
		$this->load->view('site/layoutsub',$this->data);
	}
